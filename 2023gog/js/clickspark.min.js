...
var clickSpark = function() {
	...
	function r() {
        ...
        m.canvas.width = $(".cs-canvas-container").width() > bodyWidth ? bodyWidth : 1 * $(".cs-canvas-container").width(), 
	...
	function u(e) {
        ...
        k = [], particle = null, r(), $(".cs-canvas-container").show(), $("#cs-particle-canvas").show(), window.setTimeout(function() {
